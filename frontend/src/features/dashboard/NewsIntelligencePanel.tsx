...
export function NewsIntelligencePanel({ sentiments, articles, loading, error, refreshing, onRefresh, refreshResult }: Props) {
  ...
  return <section className="panel news-intelligence" aria-labelledby="news-intelligence-title">
    ...
    <p className="inline-note">For Micho and EMA20 Pullback, all News is advisory only, including hard events. It cannot block a BUY or cause a SELL. Micho retains deterministic system loss control; EMA20 may require an explicit user-managed manual stop. Entry safety and all other non-News portfolio constraints remain mandatory.</p>
