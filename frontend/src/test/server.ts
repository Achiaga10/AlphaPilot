...
export const dailyBriefFixture = {
  ...
  actionable_opportunities: [{ ticker: 'EMA', strategy: 'ema20-pullback', strategy_profile_id: 'ema20-pullback-v1', strategy_profile_version: 1, source_plan_id: 'ema-plan', portfolio_revision: 0, selection_policy: 'relative-strength-20', sizing_policy: 'equal-slot', decision: 'BUY', decision_reason: 'BUY_APPROVED', ranking_score: '0.05', reference_price: '50', proposed_shares: 100, target_allocation_dollars: '5000', target_weight_pct: '5', sector: 'Technology', execution_readiness: 'ACTIONABLE', execution_readiness_reason: 'MANUAL_STOP_REQUIRED', loss_control_policy: 'NONE', loss_control_boundary: null, loss_control_trigger: null, loss_control_distance_dollars: null, loss_control_distance_pct: null, broker_stop_order: false, loss_control_source: 'USER_MANUAL', manual_stop_required: true, strategy_references: [], analysis_as_of_date: '2026-08-28', action_id: '1:BUY:EMA', workflow_status: 'READY_FOR_REVIEW' }],
  research_only_opportunities: [],
  deferred_opportunities: [{ ticker: 'FAST', strategy: 'micho-150', strategy_profile_id: 'micho-150-v1', strategy_profile_version: 1, source_plan_id: 'micho-plan', portfolio_revision: 0, selection_policy: 'relative-strength-20', sizing_policy: 'atr-volatility-normalized', decision: 'BUY', decision_reason: 'BUY_APPROVED', ranking_score: '0.10', reference_price: '120', proposed_shares: 80, target_allocation_dollars: '9600', target_weight_pct: '9.6', sector: 'Industrials', execution_readiness: 'ACTIONABLE', execution_readiness_reason: 'LOSS_CONTROL_READY', loss_control_policy: 'SMA150_COMPLETED_CLOSE_EXIT', loss_control_boundary: '108', loss_control_trigger: 'COMPLETED_DAILY_CLOSE_BELOW', loss_control_distance_dollars: '12', loss_control_distance_pct: '10', broker_stop_order: false, loss_control_source: 'APPROVED_SYSTEM_POLICY', manual_stop_required: false, strategy_references: [], analysis_as_of_date: '2026-08-28', action_id: '1:BUY:FAST', workflow_status: 'WAITING_FOR_REQUIRED_EXITS' }],
...
export const handlers = [
  ...
  http.get(`${API_BASE_URL}/api/v1/notifications/status`, () => HttpResponse.json({ enabled: false, email_enabled: false, configured: false, worker_running: false, queue_depth: 0, pending_count: 0, failed_count: 0, last_delivery_at: null, last_error: null })),
  http.get(`${API_BASE_URL}/api/v1/notifications`, () => HttpResponse.json([])),
  http.get(`${API_BASE_URL}/api/v1/notifications/preferences`, () => HttpResponse.json({ notifications_enabled: false, email_enabled: false, recipient: null, warning_enabled: true, critical_enabled: true, recovery_enabled: true, daily_summary_enabled: false })),
  http.put(`${API_BASE_URL}/api/v1/notifications/preferences`, async ({ request }) => HttpResponse.json(await request.json())),
  http.post(`${API_BASE_URL}/api/v1/notifications/test`, () => HttpResponse.json({ id: 'test-notification', incident_id: null, channel: 'EMAIL', status: 'PENDING', kind: 'TEST', priority: 'TEST', transition: 'TEST', generation: 1, recipient: 'operator@example.com', subject: '[AlphaPilot][TEST] Operational notification', deduplication_key: 'test:1:EMAIL', trading_session: null, scheduled_at: '2026-09-16T12:00:00Z', next_attempt_at: '2026-09-16T12:00:00Z', sent_at: null, last_attempt_at: null, attempt_count: 0, failure_category: null, provider_message_reference: null, created_at: '2026-09-16T12:00:00Z', updated_at: '2026-09-16T12:00:00Z', attempts: [] }, { status: 201 })),
  http.post(`${API_BASE_URL}/api/v1/notifications/:notificationId/retry`, ({ params }) => HttpResponse.json({ id: String(params.notificationId), incident_id: null, channel: 'EMAIL', status: 'RETRY_PENDING', kind: 'TEST', priority: 'TEST', transition: 'TEST', generation: 1, recipient: 'operator@example.com', subject: '[AlphaPilot][TEST] Operational notification', deduplication_key: 'test:1:EMAIL', trading_session: null, scheduled_at: '2026-09-16T12:00:00Z', next_attempt_at: '2026-09-16T12:00:00Z', sent_at: null, last_attempt_at: null, attempt_count: 1, failure_category: null, provider_message_reference: null, created_at: '2026-09-16T12:00:00Z', updated_at: '2026-09-16T12:00:00Z', attempts: [] })),
  ...
  http.get(`${API_BASE_URL}/api/v1/portfolio/:portfolioId/excluded-tickers`, () => HttpResponse.json([])),
  http.get(`${API_BASE_URL}/api/v1/portfolio/:portfolioId/paper-analytics`, () => HttpResponse.json({
    portfolio_id: planFixture.portfolio_id, evidence_domain: 'FORWARD_PAPER_EVIDENCE',
    generated_at: '2026-09-01T00:00:00Z', total_trade_count: 2, open_trade_count: 1,
    closed_trade_count: 1, wins: 1, losses: 0, breakeven: 0, gross_realized_pnl: '125.50',
    win_rate_percent: '100', average_return_percent: '5', evidence_maturity: 'VERY_LOW_SAMPLE',
    complete_evidence_count: 1, partial_evidence_count: 0, legacy_evidence_count: 1,
    strategy_breakdown: [{ strategy_profile_id: 'ema20-pullback-v1', strategy_profile_version: 1,
      open_trade_count: 1, closed_trade_count: 1, wins: 1, losses: 0, breakeven: 0,
      win_rate_percent: '100', average_return_percent: '5', gross_total_pnl: '125.50',
      evidence_maturity: 'VERY_LOW_SAMPLE' }],
    open_trades: [{ record: { id: 'paper-cycle-open', portfolio_id: planFixture.portfolio_id, position_id: 'apa-position', ticker: 'APA', status: 'OPEN', execution_source: 'ALPACA_PAPER_MANUAL', position_provenance: 'PLAN_PROFILE', strategy: 'ema20-pullback', strategy_profile_id: 'ema20-pullback-v1', strategy_profile_version: 1, planned_quantity: 25, reference_entry_price: '42', actual_quantity: 25, actual_entry_price: '42.10', actual_entry_at: '2026-08-28T05:12:00Z', entry_fill_difference: '0.10', entry_fill_difference_bps: '23.81', quantity_difference: 0, actual_exit_quantity: null, actual_exit_price: null, actual_exit_at: null, paper_gross_pnl: null, paper_gross_return_pct: null, alphapilot_exit_triggered_on: null, alphapilot_exit_reason: null, evidence_completeness: 'FULL', entry_evidence_schema_version: 1, entry_evidence: {}, exit_evidence_schema_version: null, exit_evidence: null, entry_slippage_percent: '0.2381', entry_adverse_slippage_dollars_per_share: '0.10', quantity_adherence_percent: '100', planned_notional: '1050', actual_entry_notional: '1052.50', fees_available: false, net_paper_pnl: null, calendar_days_held: 4 }, evidence_domain: 'FORWARD_PAPER_EVIDENCE', completed_sessions_held: 2, calendar_days_held: 4, mfe_percent: '2', mae_percent: '-1', excursion_session_count: 2, post_exit_observations: {}, current_completed_session: '2026-09-01', current_completed_close: '43', current_unrealized_pnl: '22.50' }],
    closed_trades: [{ record: { id: 'paper-cycle-closed', portfolio_id: planFixture.portfolio_id, position_id: 'apa-position', ticker: 'APA', status: 'CLOSED', execution_source: 'ALPACA_PAPER_MANUAL', position_provenance: 'PLAN_PROFILE', strategy: 'ema20-pullback', strategy_profile_id: 'ema20-pullback-v1', strategy_profile_version: 1, planned_quantity: 25, reference_entry_price: '40', actual_quantity: 25, actual_entry_price: '40', actual_entry_at: '2026-08-20T05:10:00Z', entry_fill_difference: '0', entry_fill_difference_bps: '0', quantity_difference: 0, actual_exit_quantity: 25, actual_exit_price: '45.02', actual_exit_at: '2026-08-27T05:11:00Z', paper_gross_pnl: '125.50', paper_gross_return_pct: '12.55', alphapilot_exit_triggered_on: null, alphapilot_exit_reason: null, evidence_completeness: 'LEGACY', entry_evidence_schema_version: null, entry_evidence: null, exit_evidence_schema_version: null, exit_evidence: null, entry_slippage_percent: null, entry_adverse_slippage_dollars_per_share: null, quantity_adherence_percent: null, planned_notional: '1000', actual_entry_notional: '1000', fees_available: false, net_paper_pnl: null, calendar_days_held: 7 }, evidence_domain: 'FORWARD_PAPER_EVIDENCE', completed_sessions_held: 5, calendar_days_held: 7, mfe_percent: '13', mae_percent: '-2', excursion_session_count: 5, post_exit_observations: {}, current_completed_session: null, current_completed_close: null, current_unrealized_pnl: null }],
  })),
  http.get(`${API_BASE_URL}/api/v1/portfolio/:portfolioId/daily-brief`, () => HttpResponse.json(dailyBriefFixture)),
  http.get(`${API_BASE_URL}/api/v1/portfolio/:portfolioId/news`, () => HttpResponse.json([{ id: '81111111-1111-4111-8111-111111111111', ticker: 'APA', provider: 'FINNHUB', provider_article_id: 'news-1', canonical_url: 'https://example.com/apa-guidance', headline: 'APA updates full-year guidance', summary: 'The company reduced its expected revenue range.', source: 'Reuters', image_url: null, provider_category: 'company', published_at: '2026-08-29T12:00:00Z', received_at: '2026-08-29T12:01:00Z', classification: { classification_status: 'CLASSIFIED', classification_provider: 'GOOGLE_GEMINI', classification_model: 'gemini-3.5-flash-lite', classification_version: 'news-financial-impact-v1', classified_at: '2026-08-29T12:01:05Z', event_type: 'GUIDANCE', impact: 'NEGATIVE', severity: 'HIGH', confidence: '0.91', reason: 'Forward revenue expectations were reduced.', failure_code: null } }])),
  http.get(`${API_BASE_URL}/api/v1/portfolio/:portfolioId/news-sentiment`, () => HttpResponse.json([{ ticker: 'APA', provider: 'ADANOS', observed_at: '2026-09-01T10:00:00Z', provider_timestamp: null, period_start: '2026-08-26', period_end: '2026-09-01', sentiment_score: '0.273', bullish_pct: '67', bearish_pct: '0', mentions: 12, source_count: 4, buzz_score: '28.5', trend: 'rising', request_scope: 'OPEN_POSITIONS', evidence_strength: 'SUFFICIENT', aggregate_effect: 'POSITIVE_CONTEXT', limitation: 'PROVIDER_DATA_TIMESTAMP_UNAVAILABLE' }])),
  http.post(`${API_BASE_URL}/api/v1/portfolio/:portfolioId/news-refresh`, ({ params }) => HttpResponse.json({ portfolio_id: String(params.portfolioId), tickers: ['APA'], fetched: 1, inserted: 0, duplicates: 1, classified: 0, classification_failures: 0, provider_failures: [], refreshed_at: '2026-09-01T10:00:00Z', scope: 'OPEN_POSITIONS', coverage: [['APA', 'CURRENT']], aggregate_requested: ['APA'], aggregate_returned: ['APA'], aggregate_reused: [], aggregate_missing: [], aggregate_api_calls: 1, aggregate_observations_persisted: 1, attributable_requested: ['APA'], attributable_api_calls: 1, targeted_classification_attempts: 0 })),
